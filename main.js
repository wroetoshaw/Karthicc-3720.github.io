!(function () {
     ...
     */ var r,
        ...
        vt = function (t) {
            var e = t.parent || n,
                r = t.keyframes ? gt : ht;
            if (C(t.inherit)) for (; e; ) r(t, e.vars.defaults), (e = e.parent || e._dp);
            return t;
        },
        wt = function (t, e, r, n) {
        ...
        Ft = function t(e, r) {
            ...
            return A(r) && (isNaN(r) || r in o)
                ? "<" === (n = r.charAt(0)) || ">" === n
                    ? ("<" === n ? s._start : s.endTime(s._repeat >= 0)) + (parseFloat(r.substr(1)) || 0)
                    : (n = r.indexOf("=")) < 0
                    ? (r in o || (o[r] = a), o[r])
                    : ((i = +(r.charAt(n - 1) + r.substr(n + 1))), n > 1 ? t(e, r.substr(0, n - 1)) + i : a + i)
                : null == r
                ? a
                : +r;
        },
        ...
        jt = function (t) {
            ...
            var e = q(t) ? t : { each: t },
                ...
                c = n;
            return (
                A(n) ? (l = c = { center: 0.5, edges: 0.5, end: 1 }[n] || 0) : !s && a && ((l = n[0]), (c = n[1])),
                function (t, s, d) {
                    var p,
                        f,
                        h,
                    ...
                    if (!S) {
                        ...
                        for (S = o[T] = [], p = a ? Math.min(b, T) * l - 0.5 : n % b, f = a ? (T * c) / b - 0.5 : (n / b) | 0, v = 0, w = y, _ = 0; _ < T; _++)
                            (h = (_ % b) - p), (g = f - ((_ / b) | 0)), (S[_] = m = u ? Math.abs("y" === u ? g : h) : x(h * h + g * g)), m > v && (v = m), m < w && (w = m);
                        "random" === n && Xt(S),
                            (S.max = v - w),
                            (S.min = w),
        ...
        Zt = function (t, e) {
            var r,
                ...
                i = R(t);
            return (
                !i && q(t) && ((r = i = t.radius || y), t.values ? ((t = Ut(t.values)), (n = !O(t[0])) && (r *= r)) : (t = Gt(t.increment))),
                It(
                    e,
                    i
                        ? k(t)
                            ...
                            : function (e) {
                                  for (var i, o, s = parseFloat(n ? e.x : e), a = parseFloat(n ? e.y : 0), u = y, l = 0, c = t.length; c--; )
                                      (i = n ? (i = t[c].x - s) * i + (o = t[c].y - a) * o : Math.abs(t[c] - s)) < u && ((u = i), (l = c));
        ...
        Qt = function (t, e, r, n) {
            return It(R(t) ? !e : !0 === r ? !!(r = 0) : !n, function () {
                return R(t) ? t[~~(Math.random() * t.length)] : (r = r || 1e-5) && (n = r < 1 ? Math.pow(10, (r + "").length - 2) : 1) && Math.floor(Math.round((t - r / 2 + Math.random() * (e - t + 0.99 * r)) / r) * r * n) / n;
            });
        },
        $t = function (t, e, r) {
        ...
        Jt = function (t) {
            for (var e, r, n, i, o = 0, s = ""; ~(e = t.indexOf("random(", o)); )
                (n = t.indexOf(")", e)), (i = "[" === t.charAt(e + 7)), (r = t.substr(e + 7, n - e - 7).match(i ? z : D)), (s += t.substr(o, e - o) + Qt(i ? r : +r[0], i ? 0 : +r[1], +r[2] || 1e-5)), (o = n + 1);
            ...
            var e = (t = (!t.name && t.default) || t).name,
                ...
                n =
                    e && !r && t.init
                        ...
                        : t,
                i = { init: G, render: Xe, add: Le, kill: Ge, modifier: je, rawVars: 0 },
        ...
        se = function (t, e, r) {
            return ((6 * (t = t < 0 ? t + 1 : t > 1 ? t - 1 : t) < 1 ? e + (r - e) * t * 6 : t < 0.5 ? r : 3 * t < 2 ? e + (r - e) * (2 / 3 - t) * 6 : e) * ie + 0.5) | 0;
        },
        ae = function (t, e, r) {
            var n,
                i,
            ...
            if (!f) {
                if (("," === t.substr(-1) && (t = t.substr(0, t.length - 1)), oe[t])) f = oe[t];
                    ...
                    if (((f = p = t.match(D)), e)) {
                        ...
                        (s = (+f[0] % 360) / 360),
                            (a = +f[1] / 100),
                            (n = 2 * (u = +f[2] / 100) - (i = u <= 0.5 ? u * (a + 1) : u + a - u * a)),
                            f.length > 3 && (f[3] *= 1),
                            (f[0] = se(s + 1 / 3, n, i)),
                            (f[1] = se(s, n, i)),
                            (f[2] = se(s - 1 / 3, n, i));
            ...
            return (
                e &&
                    ...
                    l === c ? (s = a = 0) : ((d = l - c), (a = u > 0.5 ? d / (2 - l - c) : d / (l + c)), (s = l === n ? (i - o) / d + (i < o ? 6 : 0) : l === i ? (o - n) / d + 2 : (n - i) / d + 4), (s *= 60)),
                    (f[0] = ~~(s + 0.5)),
                    (f[1] = ~~(100 * a + 0.5)),
                    (f[2] = ~~(100 * u + 0.5))),
                r && f.length < 4 && (f[3] = 1),
        ...
        le = function (t, e, r) {
            ...
            if (!i) for (s = (i = t.split(ce)).length - 1; c < s; c++) a += i[c] + u[c];
            return a + i[s];
        },
        ce = (function () {
            var t,
        ...
        fe = (function () {
            ...
            return (n = {
                ...
                wake: function () {
                    a &&
                        (!o && L() && ((i = o = window), (s = i.document || {}), (N.gsap = er), (i.gsapVersions || (i.gsapVersions = [])).push(er.version), V(Y || i.GreenSockGlobals || (!i.gsap && i) || {}), (r = i.requestAnimationFrame)),
                        t && n.sleep(),
                        (e =
                            r ||
                            function (t) {
        ...
        _e = function (t) {
            for (var e, r, n, i = {}, o = t.substr(1, t.length - 3).split(":"), s = o[0], a = 1, u = o.length; a < u; a++)
                (r = o[a]), (e = a !== u - 1 ? r.lastIndexOf(",") : r.length), (n = r.substr(0, e)), (i[s] = isNaN(n) ? n.replace(ye, "").trim() : +n), (s = r.substr(e + 1).trim());
            return i;
        },
        ve = function (t) {
            return function (e) {
        ...
        we = function t(e, r) {
            for (var n, i = e._first; i; )
                i instanceof Ee ? t(i, r) : !i.vars.yoyoEase || (i._yoyo && i._repeat) || i._yoyo === r || (i.timeline ? t(i.timeline, r) : ((n = i._ease), (i._ease = i._yEase), (i._yEase = n), (i._yoyo = r))), (i = i._next);
        },
        be = function (t, e) {
            return (
                (t &&
                        ...
                        : ge[t] ||
                          (function (t) {
                              ...
                              return s && o.length > 1 && s.config
                                  ? s.config.apply(
                                        null,
                                        ~t.indexOf("{") ? [_e(o[1])] : ((e = t), (r = e.indexOf("(") + 1), (n = e.indexOf(")")), (i = e.indexOf("(", r)), e.substring(r, ~i && i < n ? e.indexOf(")", n + 1) : n)).split(",").map(pt)
                                    )
                                  : ge._CE && me.test(t)
                                  ? ge._CE("", t)
                                  : s;
    ...
    st("Linear,Quad,Cubic,Quart,Quint,Strong", function (t, e) {
        ...
        xe(
            ...
            (h = function (t) {
                return t < f ? d * t * t : t < 0.7272727272727273 ? d * Math.pow(t - 1.5 / p, 2) + 0.75 : t < 0.9090909090909092 ? d * (t -= 2.25 / p) * t + 0.9375 : d * Math.pow(t - 2.625 / p, 2) + 0.984375;
            })
        ),
        xe("Expo", function (t) {
    ...
    ht(Oe.prototype, { _time: 0, _start: 0, _end: 0, _tTime: 0, _tDur: 0, _dirty: 0, _repeat: 0, _yoyo: !1, parent: null, _initted: !1, _rDelay: 0, _ts: 1, _dp: 0, ratio: 0, _zTime: -1e-8, _prom: 0, _ps: !1, _rts: 1 });
    var Ee = (function (r) {
        function i(e, n) {
            var i;
            return (
        ...
        return (
            ...
            (o.render = function (t, e, r) {
                ...
                if (w !== this._tTime || r || b) {
                    if ((m !== this._time && v && ((w += this._time - m), (t += this._time - m)), (i = w), (p = this._start), (l = !(d = this._ts)), b && (v || (m = this._zTime), (t || !e) && (this._zTime = t)), this._repeat)) {
                        ...
                        if (
                            ((i = at(w % u)),
                            w === y ? ((a = this._repeat), (i = v)) : ((a = ~~(w / u)) && a === w / u && ((i = v), a--), i > v && (i = v)),
                            (f = kt(this._tTime, u)),
                    ...
                    this._onUpdate && !e && ee(this, "onUpdate", !0),
                        ((w === y && y >= this.totalDuration()) || (!w && m)) &&
                            ((p !== this._start && Math.abs(d) === Math.abs(this._ts)) ||
                                this._lock ||
                                ((t || !v) && ((w === y && this._ts > 0) || (!w && this._ts < 0)) && bt(this, 1),
                                e || (t < 0 && !m) || (!w && !m) || (ee(this, w === y ? "onComplete" : "onReverseComplete", !0), this._prom && !(w < y && this.timeScale() > 0) && this._prom())));
                }
                return this;
            }),
            (o.add = function (t, e) {
            ...
            (o.totalTime = function (t, e) {
                return arguments.length
                    ? ((this._forcing = 1), !this._dp && this._ts && (this._start = at(fe.time - (this._ts > 0 ? t / this._ts : (this.totalDuration() - t) / -this._ts))), r.prototype.totalTime.call(this, t, e), (this._forcing = 0), this)
                    : this._tTime;
            }),
            ...
            (o.getTweensOf = function (t, e) {
                for (var r, n = [], i = Ut(t), o = this._first, s = O(e); o; )
                    o instanceof Be
                        ? ut(o._targets, i) && (s ? (!qe || (o._initted && o._ts)) && o.globalTime(0) <= e && o.globalTime(o.totalDuration()) > e : !e || o.isActive()) && n.push(o)
                ...
                if (s._dirty) {
                    for (i = s.parent; a; )
                        (e = a._prev),
                            ...
                            (r = a._start) > u && s._sort && a._ts && !s._lock ? ((s._lock = 1), (Lt(s, a, r - a._delay, 1)._lock = 0)) : (u = r),
                            r < 0 && a._ts && ((o -= r), ((!i && !s._dp) || (i && i.smoothChildTiming)) && ((s._start += r / s._ts), (s._time -= r), (s._tTime -= r)), s.shiftChildren(-r, !1, -Infinity), (u = 0)),
    ...
    var qe,
        Ce = function (t, e, r, n, i, o, s) {
            var a,
                ...
                m = 0,
                y = 0;
            for (g.b = r, g.e = n, r += "", (f = ~(n += "").indexOf("random(")) && (n = Jt(n)), o && (o((h = [r, n]), t, e), (r = h[0]), (n = h[1])), u = r.match(F) || []; (a = F.exec(n)); )
                (c = a[0]),
                    (d = n.substring(m, a.index)),
                    l ? (l = (l + 1) % 5) : "rgba(" === d.substr(-5) && (l = 1),
                    c !== u[y++] &&
                        ((p = parseFloat(u[y - 1]) || 0),
                        (g._pt = { _next: g._pt, p: d || 1 === y ? d : ",", s: p, c: "=" === c.charAt(1) ? parseFloat(c.substr(2)) * ("-" === c.charAt(0) ? -1 : 1) : parseFloat(c) - p, m: l && l < 4 ? Math.round : 0 }),
                        (m = F.lastIndex));
        ...
        Le = function (t, e, r, n, i, o, s, a, u) {
            ...
            var l,
                ...
                p = k(c) ? (u ? ze : Ie) : Fe;
            if ((A(n) && (~n.indexOf("random(") && (n = Jt(n)), "=" === n.charAt(1) && (n = parseFloat(d) + parseFloat(n.substr(2)) * ("-" === n.charAt(0) ? -1 : 1) + (Ht(d) || 0))), d !== n))
                return isNaN(d * n)
                    ? (!c && !(e in t) && U(e, n), Ce.call(this, t, e, d, n, p, a || g.stringFilter, u))
                    : ((l = new $e(this._pt, t, e, +d || 0, n - (d || 0), "boolean" == typeof c ? Ve : Ye, 0, p)), u && (l.fp = u), s && l.modifier(s, this, t), (this._pt = l));
        },
        Me = function (t, e, r, n, i, o) {
            ...
            if (
                ...
                ((r._pt = a = new $e(r._pt, i, t, 0, 1, s.render, s, 0, s.priority)), r !== l)
            )
        ...
        Pe = function t(e, i) {
            ...
            if ((I && (!L || !b) && (b = "none"), (e._ease = be(b, m.ease)), (e._yEase = q ? ve(be(!0 === q ? b : q, m.ease)) : 0), q && e._yoyo && !e._repeat && ((q = e._yEase), (e._yEase = e._ease), (e._ease = q)), !I)) {
                if (((y = (p = D[0] ? it(D[0]).harness : 0) && w[p.prop]), (o = _t(w, Z)), R && R.render(-1, !0).kill(), x)) {
                    if ((bt((e._startAt = Be.set(D, ht({ data: "isStart", overwrite: !1, parent: W, immediateRender: !0, lazy: C(S), startAt: null, delay: 0, onUpdate: A, onUpdateParams: k, callbackScope: O, stagger: 0 }, x)))), T))
                        if (i > 0) M || (e._startAt = 0);
                        else if (P && !(i < 0 && R)) return void (i && (e._zTime = i));
                } else if (E && P)
                    if (R) !M && (e._startAt = 0);
                    else if ((i && (T = !1), (a = ht({ overwrite: !1, data: "isFromStart", lazy: T && C(S), immediateRender: T, stagger: 0, parent: W }, o)), y && (a[p.prop] = y), bt((e._startAt = Be.set(D, a))), T)) {
                        if (!i) return;
                    } else t(e._startAt, _);
                for (e._pt = 0, S = (P && C(S)) || (S && !P), s = 0; s < D.length; s++) {
                    if (
                        ...
                        p &&
                            ...
                            ((e._pt = u = new $e(e._pt, l, f.name, 0, 1, f.render, f, 0, f.priority)),
        ...
        Be = (function (i) {
            function o(e, o, s, a) {
                ...
                if (((u._targets = D.length ? nt(D) : X("GSAP target " + e + " not found. https://greensock.com", !g.nullTargetWarn) || []), (u._ptLookup = []), (u._overwrite = T), S || x || M(v) || M(w))) {
                    if (((o = u.vars), (l = u.timeline = new Ee({ data: "nested", defaults: A || {} })).kill(), (l.parent = l._dp = t(u)), (l._start = 0), S))
                        ht(l.vars.defaults, { ease: "none" }),
                            S.forEach(function (t) {
                                return l.to(D, t, ">");
                            });
                    else {
                        if (((p = D.length), (m = x ? jt(x) : G), q(x))) for (f in x) ~De.indexOf(f) && (y || (y = {}), (y[f] = x[f]));
                        for (c = 0; c < p; c++) {
                            ...
                            (d.stagger = 0),
                                ...
                                !x && 1 === p && d.delay && ((u._delay = w = d.delay), (u._start += w), (d.delay = 0)),
                                l.to(h, d, m(c, h, D));
                        }
                ...
                return (
                    ...
                    L && Ct(L, t(u)),
                    (b || (!v && !S && u._start === at(L._time) && C(b) && St(t(u)) && "nested" !== L.data)) && ((u._tTime = -1e-8), u.render(Math.max(0, -w))),
                    k && Mt(t(u), k),
                    u
                );
            }
            ...
            return (
                    ...
                    if (h) {
                        if (g !== this._tTime || !t || r || (!this._initted && this._tTime) || (this._startAt && this._zTime < 0 != t < 0)) {
                            if (((n = g), (c = this.timeline), this._repeat)) {
                                ...
                                if (
                                    ((n = at(g % s)),
                                    g === f ? ((o = this._repeat), (n = h)) : ((o = ~~(g / s)) && o === g / s && ((n = h), o--), n > h && (n = h)),
                            ...
                            (c && c.render(t < 0 ? t : !n && u ? -1e-8 : c._dur * l, e, r)) || (this._startAt && (this._zTime = t)),
                                this._onUpdate && !e && (t < 0 && this._startAt && this._startAt.render(t, !0, r), ee(this, "onUpdate")),
                                ...
                                (g !== this._tDur && g) ||
                                    ...
                                    e || (t < 0 && !p) || (!g && !p) || (ee(this, g === f ? "onComplete" : "onReverseComplete", !0), this._prom && !(g < f && this.timeScale() > 0) && this._prom()));
                        }
                    } else
                        !(function (t, e, r, n) {
                            var i,
                                ...
                                c = 0;
                            if (
                                (l && t._repeat && ((c = zt(0, t._tDur, e)), (o = kt(c, l)), (s = kt(t._tTime, l)), t._yoyo && 1 & o && (u = 1 - u), o !== s && ((a = 1 - u), t.vars.repeatRefresh && t._initted && t.invalidate())),
                                ...
                                t._startAt && e < 0 && t._startAt.render(e, !0, !0),
                                    ...
                                    (e >= t._tDur || e < 0) && t.ratio === u && (u && bt(t, 1), r || (ee(t, u ? "onComplete" : "onReverseComplete", !0), t._prom && t._prom()));
                ...
                (s.kill = function (t, e) {
                    ...
                    for (
                            ...
                            "all" !== e &&
                                ...
                                (e = (function (t, e) {
                                    var r,
                                        ...
                                        a = s && s.aliases;
                                    if (!a) return e;
                                    for (n in ((r = mt({}, e)), a)) if ((n in r)) for (i = (o = a[n].split(",")).length; i--; ) r[o[i]] = r[n];
                                    return r;
                                })(c, e))),
                            l = c.length;
                        l--;
                        ...
                        if (~d.indexOf(c[l]))
                            for (a in ((i = p[l]), "all" === e ? ((n[l] = e), (s = i), (o = {})) : ((o = n[l] = n[l] || {}), (s = e)), s))
                                (u = i && i[a]) && (("kill" in u.d && !0 !== u.d.kill(a)) || wt(this, u, "_pt"), delete i[a]), "all" !== o && (o[a] = 1);
                ...
                (o.delayedCall = function (t, e, r, n) {
                    return new o(e, 0, { immediateRender: !1, lazy: !1, overwrite: !1, delay: t, onComplete: e, onReverseComplete: e, onCompleteParams: r, onReverseCompleteParams: r, callbackScope: n });
                }),
    ...
    st(
        ...
        (n = new Ee({ sortChildren: !1, defaults: m, autoRemoveChildren: !0, id: "root", smoothChildTiming: !0 })),
        (g.stringFilter = pe);
    var Je = {
        ...
        exportRoot: function (t, e) {
            ...
            var r,
                i,
                o = new Ee(t);
            for (o.smoothChildTiming = C(t.smoothChildTiming), n.remove(o), o._dp = 0, o._time = o._tTime = n._time, r = n._first; r; )
                (i = r._next), (!e && !r._dur && r instanceof Be && r.vars.onComplete === r._targets[0]) || Lt(o, r, r._start - r._delay), (r = i);
            return Lt(n, o, 0), o;
        },
        utils: {
            ...
            interpolate: function t(e, r, n, i) {
                ...
                if (!o) {
                    var s,
                        ...
                        d = A(e),
                        p = {};
                    if ((!0 === n && (i = 1) && (n = null), d)) (e = { p: e }), (r = { p: r });
                    else if (R(e) && !R(r)) {
                    ...
                    n._onInit = function (t) {
                        ...
                        !(function (t, e) {
                            var r,
                                ...
                                i,
                                o = t._targets;
                            for (r in e) for (n = o.length; n--; ) (i = t._ptLookup[n][r]) && (i = i.d) && (i._pt && (i = Ke(i, r)), i && i.modifier && i.modifier(e[r], t, o[n], r));
                        })(t, r);
                    };
                },
            };
    ...
    var rr,
        ...
        Br = function t(e) {
            var r,
                n = Mr("svg", (this.ownerSVGElement && this.ownerSVGElement.getAttribute("xmlns")) || "http://www.w3.org/2000/svg"),
                i = this.parentNode,
                o = this.nextSibling,
                s = this.style.cssText;
            if ((ir.appendChild(n), n.appendChild(this), (this.style.display = "block"), e))
                try {
        ...
        Ir = function (t) {
            ...
            return (e && (e.width || e.height)) || t.getBBox === Br || (e = Br.call(t, !0)), !e || e.width || e.x || e.y ? e : { x: +Fr(t, ["x", "cx", "x1"]) || 0, y: +Fr(t, ["y", "cy", "y1"]) || 0, width: 0, height: 0 };
        },
        zr = function (t) {
            ...
            return i === c || !l || Yr[i] || Yr[c]
                ...
                : ("px" !== c && !m && (l = t(e, r, n, "px")),
                  ...
                  (!y && "%" !== c) || (!cr[r] && !~r.indexOf("adius"))
                      ...
                      : ((o = u ? e.getBBox()[p ? "width" : "height"] : e[h]), at(y ? (l / o) * g : (l / 100) * o)));
        },
        Ur = function (t, e, r, n) {
            var i;
            return (
                ...
                cr[e] && "transform" !== e
                    ? ((i = rn(t, n)), (i = "transformOrigin" !== e ? i[e] : nn(Pr(t, Lr)) + " " + i.zOrigin + "px"))
                    : (!(i = t.style[e]) || "auto" === i || n || ~(i + "").indexOf("calc(")) && (i = (Zr[e] && Zr[e](t, e, r)) || Pr(t, e) || ot(t, e) || ("opacity" === e ? 1 : 0)),
                ...
                for (; (a = B.exec(n)); )
                    (p = a[0]),
                        ...
                        p !== (d = u[b++] || "") &&
                            ...
                            m || ((m = m || g.units[e] || y), w === n.length && ((n += m), (v.e += m))),
                            y !== m && (l = Vr(t, e, d, m) || 0),
                            (v._pt = { _next: v._pt, p: h || 1 === b ? h : ",", s: l, c: _ ? _ * f : f - l, m: (c && c < 4) || "zIndex" === e ? Math.round : 0 }));
        ...
        Gr = function (t, e) {
            if (e.tween && e.tween._time === e.tween._dur) {
                ...
                else for (i = (a = a.split(",")).length; --i > -1; ) (r = a[i]), cr[r] && ((n = 1), (r = "transformOrigin" === r ? Lr : Cr)), Hr(o, r);
        ...
        tn = function (t, e) {
            ...
            return s.svg && t.getAttribute("transform")
                ...
                : (u !== Qr ||
                      ...
                      ((i = a.display),
                      (a.display = "block"),
                      ((r = t.parentNode) && t.offsetParent) || ((o = 1), (n = t.nextSibling), ir.appendChild(t)),
                      (u = Kr(t)),
        ...
        en = function (t, e, r, n, i, o) {
            var s,
                ...
                T = parseFloat(b[1]) || 0;
            r
                ? c !== Qr && (a = g * _ - m * y) && ((u = x * (-m / a) + T * (g / a) - (g * w - m * v) / a), (x = x * (_ / a) + T * (-y / a) + (y * w - _ * v) / a), (T = u))
                : ((x = (s = Ir(t)).x + (~b[0].indexOf("%") ? (x / 100) * s.width : x)), (T = s.y + (~(b[1] || b[0]).indexOf("%") ? (T / 100) * s.height : T))),
                n || (!1 !== n && l.smooth) ? ((v = x - d), (w = T - p), (l.xOffset = f + (v * g + w * y) - v), (l.yOffset = h + (v * m + w * _) - w)) : (l.xOffset = l.yOffset = 0),
                (l.xOrigin = x),
                (l.yOrigin = T),
                (l.smooth = !!n),
                (l.origin = e),
                ...
                (t.style[Lr] = "0px 0px"),
                o && (Nr(o, l, "xOrigin", d, x), Nr(o, l, "yOrigin", p, T), Nr(o, l, "xOffset", f, l.xOffset), Nr(o, l, "yOffset", h, l.yOffset)),
        ...
        rn = function (t, e) {
            ...
            return (
                ...
                (r.svg = !(!t.getCTM || !zr(t))),
                (y = tn(t, r.svg)),
                r.svg && ((O = !r.uncache && t.getAttribute("data-svg-origin")), en(t, O || z, !!O || r.originIsAbsolute, !1 !== r.smooth, y)),
                (h = r.xOrigin || 0),
                (m = r.yOrigin || 0),
                y !== Qr &&
                    ((b = y[0]),
                    ...
                    6 === y.length
                        ...
                        : ((D = y[6]),
                          ...
                          _ &&
                              ...
                              (D = q)),
                          (c = (_ = fr(-T, M)) * dr),
                          _ && ((v = Math.cos(-_)), (R = S * (w = Math.sin(-_)) + R * v), (b = O = b * v - C * w), (x = E = x * v - L * w), (T = q = T * v - M * w)),
                          (u = (_ = fr(x, b)) * dr),
                          _ && ((O = b * (v = Math.cos(_)) + x * (w = Math.sin(_))), (E = A * v + k * w), (x = x * v - b * w), (k = k * v - A * w), (b = O), (A = E)),
                          ...
                          (f = R ? 1 / (R < 0 ? -R : R) : 0)),
                    r.svg && ((O = t.getAttribute("transform")), (r.forceCSS = t.setAttribute("transform", "") || !Jr(Pr(t, Cr))), O && t.setAttribute("transform", O))),
                Math.abs(d) > 90 && Math.abs(d) < 270 && (B ? ((s *= -1), (d += u <= 0 ? 180 : -180), (u += u <= 0 ? 180 : -180)) : ((a *= -1), (d += d <= 0 ? 180 : -180))),
            ...
            (p = parseFloat(p)),
                ...
                p || f
                    ? ((p *= pr),
                      ...
                      (i = Math.sin(p - f) * -m),
                      (o = Math.cos(p - f) * m),
                      f && ((h *= pr), (s = Math.tan(f - h)), (i *= s = Math.sqrt(1 + s * s)), (o *= s), h && ((s = Math.tan(h)), (r *= s = Math.sqrt(1 + s * s)), (n *= s))),
                      (r = at(r)),
                      (n = at(n)),
                      (i = at(i)),
                      (o = at(o)))
                    : ((r = g), (o = m), (n = i = 0)),
                ((T && !~(c + "").indexOf("px")) || (S && !~(d + "").indexOf("px"))) && ((T = Vr(y, "x", c, "px")), (S = Vr(y, "y", d, "px"))),
                (_ || v || w || b) && ((T = at(T + _ - (_ * r + v * i) + w)), (S = at(S + v - (_ * n + v * o) + b))),
                (u || l) && ((s = y.getBBox()), (T = at(T + (u / 100) * s.width)), (S = at(S + (l / 100) * s.height))),
        ...
        pn = function (t, e, r, n, i, o) {
            var s,
                ...
                p = n + d + "deg";
            return (
                l && ("short" === (s = i.split("_")[1]) && (d %= u) !== d % 180 && (d += d < 0 ? u : -360), "cw" === s && d < 0 ? (d = ((d + 36e9) % u) - ~~(d / u) * u) : "ccw" === s && d > 0 && (d = ((d - 36e9) % u) - ~~(d / u) * u)),
        ...
        fn = function (t, e, r) {
            var n,
                ...
                c = ar.style,
                d = r._gsap;
            for (i in ((c.cssText = getComputedStyle(r).cssText + ";position:absolute;display:block;"), (c[Cr] = e), nr.body.appendChild(ar), (n = rn(ar, 1)), cr))
                (o = d[i]) !== (s = n[i]) &&
                    "perspective,force3D,transformOrigin,svgOrigin".indexOf(i) < 0 &&
                    ((a = Ht(o) !== (l = Ht(s)) ? Vr(r, i, o, l) : parseFloat(o)), (u = parseFloat(s)), (t._pt = new $e(t._pt, d, i, a, u - a, _r)), (t._pt.u = l || 0), t._props.push(i));
                ...
                for (d in (or || Wr(), e))
                    if ("autoRound" !== d && ((s = e[d]), !J[d] || !Me(d, e, r, n, t, i)))
                        if (((l = typeof s), (c = Zr[d]), "function" === l && (l = typeof (s = s.call(r, n, t, i))), "string" === l && ~s.indexOf("random(") && (s = Jt(s)), c)) c(this, t, d, s, r) && (w = 1);
                            ...
                            (o = (getComputedStyle(t).getPropertyValue(d) + "").trim()), (s += ""), (p = Ht(o)), (f = Ht(s)) ? p !== f && (o = Vr(t, d, o, f) + f) : p && (s += p), this.add(k, "setProperty", o, s, n, i, 0, 0, d);
                        else if ("undefined" !== l) {
                            if (
                                (O && d in O ? ((o = "function" == typeof O[d] ? O[d].call(r, n, t, i) : O[d]), d in g.units && !Ht(o) && (o += g.units[d]), "=" === (o + "").charAt(1) && (o = Ur(t, d))) : (o = Ur(t, d)),
                                (u = parseFloat(o)),
                                (h = "string" === l && "=" === s.charAt(1) ? +(s.charAt(0) + "1") : 0) && (s = s.substr(2)),
                                (a = parseFloat(s)),
                                d in yr &&
                                    ("autoAlpha" === d && (1 === u && "hidden" === Ur(t, "visibility") && a && (u = 0), Nr(this, k, "visibility", u ? "inherit" : "hidden", a ? "inherit" : "hidden", !a)),
                                    "scale" !== d && "transform" !== d && ~(d = yr[d]).indexOf(",") && (d = d.split(",")[0])),
                                (m = d in cr))
                            )
                                if (
                                    (y ||
                                        (((_ = t._gsap).renderTransform && !e.parseTransform) || rn(t, e.parseTransform),
                                        (v = !1 !== e.smoothOrigin && _.smooth),
                                        ((y = this._pt = new $e(this._pt, k, Cr, 0, 1, _.renderTransform, _, 0, -1)).dep = 1)),
                                    "scale" === d)
                                )
                                    (this._pt = new $e(this._pt, _, "scaleY", _.scaleY, h ? h * a : a - _.scaleY)), A.push("scaleY", d), (d += "X");
                                else {
                                    if ("transformOrigin" === d) {
                                        (x = void 0),
                                            ...
                                            (x[1] = jr[S] || S),
                                            (s = x.join(" ")),
                                            _.svg ? en(t, s, 0, v, 0, this) : ((f = parseFloat(s.split(" ")[2]) || 0) !== _.zOrigin && Nr(this, _, "zOrigin", _.zOrigin, f), Nr(this, k, d, nn(o), nn(s)));
                                        continue;
                                    }
                                    if ("svgOrigin" === d) {
                                        en(t, s, 1, v, 0, this);
    ...
    var xn,
        ...
        Ii = function (t, e) {
            var r = e && "matrix(1, 0, 0, 1, 0, 0)" !== Bi(t)[Fn] && xn.to(t, { x: 0, y: 0, xPercent: 0, yPercent: 0, rotation: 0, rotationX: 0, rotationY: 0, scale: 1, skewX: 0, skewY: 0 }).progress(1),
        ...
        Ui = { startColor: "green", endColor: "red", indent: 0, fontSize: "16px", fontWeight: "normal" },
        ...
        To = function (t, e, r, n, i, o, s, a, u, l, c, d) {
            if ((pi(t) && (t = t(a)), di(t) && "max" === t.substr(0, 3) && (t = d + ("=" === t.charAt(4) ? Gi("0" + t.substr(3), r) : 0)), fi(t))) s && Qi(s, r, n, !0);
                ...
                var p,
                    ...
                    m = Ii(g) || {},
                    y = t.split(" ");
                (m && (m.left || m.top)) || "none" !== Bi(g).display || ((h = g.style.display), (g.style.display = "block"), (m = Ii(g)), h ? (g.style.display = h) : g.style.removeProperty("display")),
                    (p = Gi(y[0], m[n.d])),
                    (f = Gi(y[1] || "0", r)),
        ...
        return (
            (t.prototype.init = function (e, r) {
                if (((this.progress = this.start = 0), this.vars && this.kill(1), ei)) {
                    var n,
                        ...
                        z,
                        H,
                        N = (e = Fi(di(e) || fi(e) || e.nodeType ? { trigger: e } : e, Xi)).horizontal ? Di : Wi,
                        Y = e,
                        V = Y.onUpdate,
                        U = Y.toggleClass,
                        X = Y.id,
                    ...
                    (gt.media = jn),
                        ...
                        (ut.tweenScroll = ut.tweenScroll || { top: ko(at, Wi), left: ko(at, Di) }),
                        ...
                        it &&
                            (hi(it) || (it = { snapTo: it }),
                            "scrollBehavior" in On.style && xn.set(lt ? [On, kn] : at, { scrollBehavior: "auto" }),
                            (o = pi(it.snapTo)
                                ? it.snapTo
                                : "labels" === it.snapTo
                                ? (function (t) {
                                    ...
                                    if (Math.abs(gt.getVelocity()) < 10 && !Bn) {
                                        ...
                                        if (u <= c && u >= l && d !== u) {
                                            ...
                                            n(
                                                d,
                                                {
                                                    duration: D(yi((0.185 * Math.max(yi(s - t), yi(a - t))) / e / 0.05 || 0)),
                                                    ease: it.ease || "power3",
                                                    data: Math.abs(d - u),
                                                    onComplete: function () {
                        ...
                        $ &&
                            ...
                            (i = xn.core.getCache($)).spacer ? (y = i.pinState) : ((i.spacer = w = An.createElement("div")), w.setAttribute("class", "pin-spacer" + (X ? " pin-spacer-" + X : "")), (i.pinState = y = bo($))),
                        ...
                        ft &&
                            ...
                            (p = Zi("end", X, at, N, g, b)),
                            ct || (((H = lt ? On : at).style.position = "absolute" === Bi(H).position ? "absolute" : "relative"), xn.set([f, h], { force3D: !0 }), (E = xn.quickSetter(f, N.a, Ri)), (q = xn.quickSetter(h, N.a, Ri)))),
                        (gt.revert = function (t) {
                            var e = !1 !== t || !gt.enabled,
                                n = Wn;
                            e !== s &&
                                (e && ((F = Math.max(gt.scroll(), gt.scroll.rec || 0)), (B = gt.progress), (I = r && r.progress())),
                                d &&
                                ...
                                if ($ && n && ti) Yi(t, "scrollEnd", so);
                                    ...
                                    for (
                                        var i,
                                            ...
                                            z = e.end,
                                            H = e.endTrigger || Q,
                                            Y = e.start || (0 !== e.start && Q ? ($ ? "0 0" : "0 100%") : 0),
                                    ...
                                    for (
                                        l = To(Y, Q, L, N, gt.scroll(), d, f, gt, M, ht, ct, R) || ($ ? -0.001 : 0),
                                            pi(z) && (z = z(gt)),
                                            di(z) && !z.indexOf("+=") && (~z.indexOf(" ") ? (z = (di(Y) ? Y.split(" ")[0] : "") + z) : ((D = Gi(z.substr(2), L)), (z = di(Y) ? Y : l + D), (H = Q))),
                                            c = Math.max(l, To(z || (H ? "100% 0" : R), H, L, N, gt.scroll() + D, p, h, gt, M, ht, ct, R)) || -0.001,
                                            m = c - l || ((l -= 0.01) && 0.001),
                                            D = 0,
                                            U = V;
                                        U--;
                                        ...
                                        (E = (k = $i[U]).pin) && k.start - k._pinPush < l && ((i = k.end - k.start), E === Q && (D += i), E === $ && (W += i));
                                    if (((l += D), (c += D), (gt._pinPush = W), d && D && (((i = {})[N.a] = "+=" + D), xn.set([d, p], i)), $))
                                        (i = Bi($)),
                                            (b = N === Wi),
                                            (g = gt.scroll()),
                                            ...
                                            (o = Ii($, !0)),
                                            (q = ct && ai(at, b ? Di : Wi)()),
                                            J && (((O = [J + N.os2, m + W + Ri]).t = w), (U = J === Ci ? zi($, N) + m + W : 0) && O.push(N.d, U + Ri), wo(O), ct && gt.scroll(F)),
                                            ct &&
                                                (((T = { top: o.top + (b ? g - l : q) + Ri, left: o.left + (b ? q : g - l) + Ri, boxSizing: "border-box", position: "fixed" }).width = T.maxWidth = Math.ceil(o.width) + Ri),
                                            ...
                                            r ? ((C = r._initted), Vn(1), r.progress(1, !0), (A = x(N.a) - S + m + W), m !== A && _.splice(_.length - 2, 2), r.progress(0, !0), C || r.invalidate(), Vn(0)) : (A = m);
                                    else if (Q && gt.scroll()) for (o = Q.parentNode; o && o !== On; ) o._pinOffset && ((l -= o._pinOffset), (c -= o._pinOffset)), (o = o.parentNode);
                                    ...
                                    (gt.start = l),
                                        ...
                                        B !== gt.progress && (P && r.totalProgress(B, !0), (gt.progress = B), gt.update()),
                        ...
                        (gt.update = function (t, e) {
                            ...
                            if ((e && ((u = a), (a = h), it && ((M = L), (L = r && !st ? r.totalProgress() : y))), tt && !y && $ && !Wn && !Zn && ti && l < h + ((h - u) / (Jn() - Rn)) * tt && (y = 1e-4), y !== b && gt.enabled)) {
                                if (
                                    ((d = (p = (i = gt.isActive = !!y && y < 1) !== (!!b && b < 1)) || !!y != !!b),
                                    (gt.direction = y > b ? 1 : -1),
                                    (gt.progress = y),
                                    st || (!P || Wn || Zn ? r && r.totalProgress(y, !!Wn) : ((P.vars.totalProgress = y), P.invalidate().restart())),
                                    $)
                                )
                                ...
                                it && !n.tween && !Wn && !Zn && W.restart(!0),
                                    ...
                                    d && !Wn
                                        ? ((o = y && !b ? 0 : 1 === y ? 1 : 1 === b ? 2 : 3),
                                          st &&
                                              ((s = (!p && "none" !== pt[o + 1] && pt[o + 1]) || pt[o]),
                                              r && ("complete" === s || "reset" === s || s in r) && ("complete" === s ? r.pause().totalProgress(1) : "reset" === s ? r.restart(!0).pause() : r[s]()),
                                              V && V(gt)),
                                          (!p && Xn) || (j && p && j(gt), dt[o] && dt[o](gt), nt && (1 === y ? gt.kill(!1, 1) : (dt[o] = 0)), p || (dt[(o = 1 === y ? 1 : 3)] && dt[o](gt))))
                                        : st && V && !Wn && V(gt);
                            }
                        ...
                        (gt.disable = function (e, r) {
                            if (
                                ...
                                for (var o = $i.length; o--; ) if ($i[o].scroller === at && $i[o] !== gt) return;
            ...
            (t.register = function (e) {
                if (
                    !Tn &&
                    ((xn = e || ii()),
                    ni() && window.document && ((Sn = window), (An = document), (kn = An.documentElement), (On = An.body)),
                    xn && ((Mn = xn.utils.toArray), (Pn = xn.utils.clamp), (Vn = xn.core.suppressOverwrites || ri), xn.core.globals("ScrollTrigger", t), On))
                ) {
                    (Cn =
                ...
                for (r in t)
                    (n = io.indexOf(r)),
                        ...
                        "all" === r
                            ...
                            : (e = Sn.matchMedia(r)) &&
                              (e.matches && (o = i()),
                              ~n ? ((io[n + 1] = mi(io[n + 1], i)), (io[n + 2] = mi(io[n + 2], o))) : ((n = io.length), io.push(r, i, o), e.addListener ? e.addListener(oo) : e.addEventListener("change", oo)),
                              (io[n + 3] = e.matches)),
                        (jn = 0);
                return io;
            }),
    ...
    var Eo = (function () {
        function t(e) {
            vn(this, t), (this.speed = 0.035), (this.elmt = e), (this.leRaf = null), (this.isWheeling = null), (this.deltaY = 0), (this.scrollTop = 0), (this.current = 0);
        }
        return (
            bn(t, [
                {
    ...
    var Co,
        Lo =
            ((function (t) {
                ...
                (r.prototype.defaultOptions = { selector: "video[data-yt2html5]", attribute: "data-yt2html5", formats: "*", autoload: !0, withAudio: !1 }),
                    ...
                    (r.prototype.addAction = function (t, e) {
                        ...
                        this.addHook("actions", { name: t, callback: e, priority: r, global: n });
                    }),
                    ...
                    (r.prototype.addFilter = function (t, e) {
                        var r = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : 10,
                            n = !!(3 < arguments.length && void 0 !== arguments[3]) && arguments[3];
                        this.addHook("filters", { name: t, callback: e, priority: r, global: n });
                    }),
                    ...
                    (r.prototype.getAllowedFormats = function () {
                        var t = [];
                        return (
                            Array.isArray(this.options.formats) ? (t = this.options.formats) : this.itagMap[this.options.formats] ? (t = [this.options.formats]) : "*" === this.options.formats && (t = Object.values(this.itagMap).sort()), t
                        );
                    }),
                    (r.prototype.getElements = function (t) {
                        var r = null;
                        return (
                            t && (r = NodeList.prototype.isPrototypeOf(t) || HTMLCollection.prototype.isPrototypeOf(t) ? t : "object" === e(t) && "nodeType" in t && t.nodeType ? [t] : document.querySelectorAll(this.options.selector)),
                            (r = Array.from(r || "")),
                    ...
                    (r.prototype.parseYoutubeMeta = function (t) {
                        ...
                        var i = t.data || {};
                        return (
                            (i = this.applyFilters("api.response", i, t)).hasOwnProperty("url_encoded_fmt_stream_map") &&
                                (r = r.concat(
                            ...
                            r.forEach(function (t) {
                                if (t && "itag" in t && e.itagMap[t.itag]) {
                                    var r = { _raw: t, itag: t.itag, url: null, label: null, type: "unknown", mime: "unknown", hasAudio: !1, browserSupport: "unknown" };
                                    if (
                                        ...
                                        if (r) {
                                            ...
                                            if (n && Array.isArray(n)) {
                                                (n = n.filter(function (e) {
                                                    ...
                                                    var r = { unknown: -1, no: -1, maybe: 0, probably: 1 };
                                                ...
                                                (s = e.applyFilters("video.stream", s, t, a, n)) && "url" in s && s.url && (c.src = s.url),
                                                    ...
                                                    c.src && "function" == typeof c.src.toString && c.src.toString().length
                                                        ? ((t.src = c.src), c.type && c.type.length && (t.type = c.type))
                                                        : console.warn("YouTubeToHtml5 unable to load video for ID: ".concat(i));
                                            }
                                        }
                                    })
                                    .finally(function (r) {
            ...
            return (
                bn(t, [
                        ...
                        value: function (t, e, r, n) {
                            5 == window.nbSonCharges &&
                                ...
                                document.querySelector(".toSon1").classList.contains("actif")
                                    ...
                                    : document.querySelector(".toSon2").classList.contains("actif")
                                    ? (t.mute(),
                                      e.playRAF(),
                                      r.mute(),
                                      n.mute(),
                                      ...
                                      r.gainNode.gain.setValueAtTime(0, r.context.currentTime),
                                      n.gainNode.gain.setValueAtTime(0, n.context.currentTime))
                                    : document.querySelector(".toSon3").classList.contains("actif")
                                    ? (t.mute(),
                                      e.mute(),
                                      r.playRAF(),
                                      n.mute(),
                                      ...
                                      t.gainNode.gain.setValueAtTime(0, t.context.currentTime),
                                      n.gainNode.gain.setValueAtTime(0, n.context.currentTime))
                                    : document.querySelector(".toSon4").classList.contains("actif") &&
                                      (t.mute(),
                                      e.mute(),
                                      r.mute(),
                                      n.playRAF(),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            _n.to(this.progress, {
                                ...
                                this.killRAF(),
                                _n.to(this.cible, { duration: 1, y: "0px", ease: "power2.inOut" });
                        },
                    },
                    {
                        key: "unmute",
                    ...
                    },
                    {
                        key: "playRAF",
                        value: function () {
                            for (this.leRaf = requestAnimationFrame(this.playRAF.bind(this)), this.analyser.getByteFrequencyData(this.frequencyData), this.i = 0; this.i < this.frequencyDataLen; this.i++)
                                this.avg += this.frequencyData[this.i];
                            (this.avg = this.avg / this.frequencyDataLen), _n.to(this.cible, { duration: 0.1, y: 0.0016 * -this.avg * window.innerHeight + "px", ease: "none" });
                        },
                    },
                    {
                        key: "killRAF",
    ...
    ((navigator.userAgent || navigator.vendor || window.opera).indexOf("Instagram") > -1 ||
        (function () {
    ...
    window.innerHeight > window.innerWidth && (Fo = !0),
        ...
        window.addEventListener("resize", function (t) {
            qo()
                ? (window.innerWidth > window.innerHeight && Fo && document.location.reload(), window.innerWidth < window.innerHeight && (Fo = !0))
                : ((Bo = window.innerHeight),
    ...
    var Io,
        zo,
        Ho,
        No = new Mo(document.querySelector(".son1"), document.querySelector(".toSon1")),
    ...
    function Xo() {
        Oo.create({ trigger: ".SIntro", start: "top top", end: "+=" + 4.5 * window.innerHeight + "px", pin: !0 });
        var t = [];
        ...
        var r = 0;
        t.forEach(function (t) {
            _n.to(t, { scrollTrigger: { trigger: ".innerSIntro", start: "top 0%", end: "top -" + 1.2 * window.innerHeight + "-=" + r, scrub: !0 }, y: "-250%", ease: "none" }), (r += 0.48 * window.innerHeight);
        });
        var n = 0;
        e.forEach(function (t) {
            _n.to(t, { scrollTrigger: { trigger: ".innerSIntro", start: "top 0%", end: "top -" + 1.2 * window.innerHeight + "-=" + n, scrub: !0 }, y: "-250%", ease: "none" }), (n += 0.48 * window.innerHeight);
        }),
            _n.fromTo(
                ".intro",
            ...
            _n.to(".intro img", { scrollTrigger: { trigger: ".innerSIntro", start: "top 0%", end: "+=" + 4.5 * window.innerHeight + "px", scrub: !0 }, scale: 1 }),
            Oo.create({ trigger: ".biographie", start: "top top", end: "+=" + 2 * window.innerHeight + "px", pin: !0, pinSpacing: !1 }),
            _n.to(".biographie div", { scrollTrigger: { trigger: ".cita-a", start: "top top+=" + 2 * window.innerHeight + "px", end: "+=" + window.innerHeight + "px", scrub: !0 }, opacity: 0, ease: "none" }),
            ...
            document.querySelectorAll(".cita").forEach(function (t) {
                _n.to(t.querySelector(".flexbis"), { scrollTrigger: { trigger: t, start: "top top", end: "bottom bottom", scrub: !0, pin: t.querySelector(".flex") }, y: "-5%", ease: "none" });
            }),
            document.querySelectorAll(".effet1").forEach(function (t) {
                _n.to(t, { scrollTrigger: { trigger: t.closest(".cita"), start: "top 0%", end: "top -40%", scrub: !0 }, opacity: 0, ease: "none" });
            }),
            document.querySelectorAll(".effet2").forEach(function (t) {
                _n.to(t, { scrollTrigger: { trigger: t.closest(".cita"), start: "top -20%", end: "top -60%", scrub: !0 }, opacity: 0, ease: "none" });
            }),
            document.querySelectorAll(".effet3").forEach(function (t) {
                _n.to(t, { scrollTrigger: { trigger: t.closest(".cita"), start: "top -40%", end: "top -80%", scrub: !0 }, opacity: 0, ease: "none" });
            }),
            document.querySelectorAll(".effet4").forEach(function (t) {
                _n.to(t, { scrollTrigger: { trigger: t.closest(".cita"), start: "top -60%", end: "top -100%", scrub: !0 }, opacity: 0, ease: "none" });
            });
        var i = document.querySelector(".SReal").getBoundingClientRect().left + Bo;
        _n.to(".SReal", { scrollTrigger: { trigger: ".innerSlider", start: "top bottom-=" + i, end: "+=" + window.innerWidth + "px", scrub: !0 }, x: "100%", ease: "none" }),
            _n.to(".mot2", { scrollTrigger: { trigger: ".innerSlider", start: "top bottom-=" + (i - window.innerWidth), end: "+=" + 3 * window.innerWidth + "px", scrub: !0 }, x: "0%", ease: "none" }),
            _n.to(".mot1", { scrollTrigger: { trigger: ".innerSlider", start: "top bottom-=" + (i - window.innerWidth), end: "+=" + 3 * window.innerWidth + "px", scrub: !0 }, x: "-10%", ease: "none" }),
            _n.fromTo(".SReal2 .mask", { x: "-100%" }, { scrollTrigger: { trigger: ".innerSlider", start: "top bottom-=" + i, end: "+=" + window.innerWidth + "px", scrub: !0 }, x: "0%", ease: "none" }),
            document.querySelectorAll(".grosTitre span").forEach(function (t) {
                var e = t.getBoundingClientRect().left - window.innerWidth;
                _n.to(t, { scrollTrigger: { trigger: ".innerSlider", start: "top top-=" + e, end: "+=" + 0.6 * window.innerWidth, scrub: !0 }, y: 0 });
            }),
            _n.to(".innerSlider", {
                scrollTrigger: { trigger: ".innerSlider", end: "+=" + (document.querySelector(".innerSlider").offsetWidth - window.innerWidth), scrub: !0, pin: !0 },
                x: -document.querySelector(".innerSlider").offsetWidth + window.innerWidth + "px",
                ease: "none",
            }),
            _n.set(".debut", { opacity: 0 }),
            _n.to(".debut", { scrollTrigger: { trigger: ".innerCita2", start: "top 50%", end: "top top", scrub: !0 }, opacity: 1, ease: "none" }),
            _n.to(".debut", { scrollTrigger: { trigger: ".innerCita2", start: "bottom bottom", end: "bottom 50%", scrub: !0 }, opacity: 0, ease: "none", immediateRender: !1 }),
            Oo.create({ trigger: ".SConcert", start: "top bottom", end: "bottom 100%", pin: ".debut" }),
                ...
                Oo.create({
                    ...
                    onEnter: function () {
                        if (t.classList.contains("citaDSpe")) {
                            ...
                            document.querySelectorAll(".verb > span")[e].classList.contains("actif") ||
                                (document.querySelectorAll(".verb > span")[e].classList.add("actif"),
                                ...
                                _n.to(".verb span span", { opacity: 0, y: "-40%", duration: 0.2, ease: "power2.in" }),
                                _n.fromTo(".verb span.actif span", { y: "40%" }, { opacity: 1, duration: 0.2, y: "0%", delay: 0.2, stagger: 0.05, ease: "power2.out" }));
                        }
                    },
                    onEnterBack: function () {
                        var e = t.getAttribute("data-cit");
            ...
            _n.to(".truth .mot", { scrollTrigger: { trigger: ".truth .repere", start: "top 50%", end: "+=" + 2 * Bo + "px", pin: ".truth", scrub: !0 }, scale: 3.4, x: "0%", ease: "none" }),
            document.querySelectorAll(".truth span").forEach(function (t) {
                _n.to(t, { scrollTrigger: { trigger: ".SNextPast", start: "top bottom", end: "top top", scrub: !0 }, y: Math.floor(100 * Math.random()) + 0 + "%", ease: "none" });
            });
        var o = window.innerHeight - document.querySelector(".innerImg").offsetHeight - 0.15 * window.innerWidth;
        Oo.create({ trigger: ".liste", start: "top 0%", end: "bottom bottom-=" + o + "px", pin: ".innerImg" }),
            _n.to(".innerImg img", { scrollTrigger: { trigger: ".liste", start: "top 0%", end: "bottom bottom-=" + o + "px", scrub: !0 }, scale: 1, ease: "none" }),
            _n.to("#intermission", { scrollTrigger: { trigger: ".contenu__inner", start: "top top", end: "+=" + window.innerWidth + "px", scrub: !0 }, x: "100vw", ease: "none" });
        var s = window.innerWidth + Bo;
        _n.to(".notes", { scrollTrigger: { trigger: ".contenu__inner", start: "top bottom", end: "+=" + s + "px", scrub: !0 }, scale: 1.2, ease: "none" }),
            _n.to(".notes", { scrollTrigger: { trigger: ".contenu__inner", start: "top top-=" + window.innerWidth + "px", end: "+=" + window.innerWidth + "px", scrub: !0 }, x: "30%", ease: "none", immediateRender: !1 }),
            _n.to(".continue", { scrollTrigger: { trigger: ".contenu__inner", start: "top top", end: "+=" + window.innerWidth + "px", scrub: !0 }, opacity: 0, ease: "none" }),
            _n.to(".inner_inter .phrase, .inner_inter .inter", { scrollTrigger: { trigger: ".contenu__inner", start: "top top-=" + window.innerWidth + "px", end: "+=" + window.innerWidth + "px", scrub: !0 }, opacity: 0, ease: "none" }),
            Oo.create({
                trigger: ".SRecording",
                start: "top bottom",
                end: "+=" + (Bo + 2 * window.innerWidth) + "px",
                onEnter: function () {
                    _n.killTweensOf(".uneNote"), _n.fromTo(".uneNote", { y: "-150%", opacity: 0 }, { y: "0%", opacity: 1, stagger: -0.1, duration: 1.1, delay: 0.5, ease: "elastic.out" });
                },
                onEnterBack: function () {
                    _n.killTweensOf(".uneNote"), _n.fromTo(".uneNote", { y: "-150%", opacity: 0 }, { y: "0%", opacity: 1, stagger: -0.1, duration: 1.2, ease: "elastic.out" });
                },
                onLeave: function () {
                    1 == window.quuneFois &&
                        (No.mute(),
            ...
            document.querySelectorAll(".SRecording .lArt").forEach(function (t) {
                ...
                _n.fromTo(t.querySelector("span"), { x: "-100%" }, { scrollTrigger: { trigger: ".contenu__inner", start: "top bottom-=" + e, end: "+=" + t.offsetWidth, scrub: !0 }, x: "0%", ease: "none" });
            }),
            _n.to(".contenu__inner", {
                scrollTrigger: { trigger: ".contenu__inner", end: "+=" + (document.querySelector(".contenu__inner").offsetWidth - window.innerWidth), scrub: !0, pin: !0 },
            ...
            document.querySelectorAll(".lien span").forEach(function (t) {
                _n.to(t, { scrollTrigger: { trigger: ".STitular", start: "top top+=" + (window.innerHeight + 2 * window.innerWidth) + "px", end: "+=" + window.innerWidth, scrub: !0 }, x: 0, ease: "none" });
            }),
            ...
            _n.fromTo(".div1", { y: "250%" }, { scrollTrigger: { trigger: ".STitular", start: "top top+=" + (window.innerHeight + window.innerWidth) + "px", end: "+=" + window.innerWidth, scrub: !0 }, y: "0%", ease: "none" }),
            _n.fromTo(".div2", { y: "200%" }, { scrollTrigger: { trigger: ".STitular", start: "top top+=" + (window.innerHeight + window.innerWidth) + "px", end: "+=" + window.innerWidth, scrub: !0 }, y: "0%", ease: "none" }),
            _n.fromTo(".div3", { y: "150%" }, { scrollTrigger: { trigger: ".STitular", start: "top top+=" + (window.innerHeight + window.innerWidth) + "px", end: "+=" + window.innerWidth, scrub: !0 }, y: "0%", ease: "none" }),
            _n.fromTo(".div4", { y: "100%" }, { scrollTrigger: { trigger: ".STitular", start: "top top+=" + (window.innerHeight + window.innerWidth) + "px", end: "+=" + window.innerWidth, scrub: !0 }, y: "0%", ease: "none" }),
            Oo.create({ trigger: ".innerFix", start: "top top", end: "+=" + 4.5 * Bo + "px", pin: !0 }),
            _n.to(".img .flInvert", {
                scrollTrigger: {
                    trigger: ".SProfessor",
                    start: "top +=" + 3 * Bo + "px",
                    ...
                    onEnter: function () {
                        _n.killTweensOf(".STitular .texte div, .amazing div, .innerSvg, .innerSvg img"),
                            _n.to(".STitular .texte div", { y: "-100%", duration: 0.8, ease: "power4.in" }),
                            _n.to(".amazing div, .innerSvg, .innerSvg img", { y: "0%", duration: 1.5, delay: 0.8, opacity: 1, ease: "power4.out" });
                    },
                    onLeaveBack: function () {
                        _n.killTweensOf(".STitular .texte div, .amazing div, .innerSvg, .innerSvg img"),
                            _n.to(".amazing div, .innerSvg", { y: "100%", duration: 0.8, ease: "power4.in" }),
                            _n.to(".innerSvg img", { y: "-100%", opacity: 0, duration: 0.8, ease: "power4.in" }),
                            _n.to(".STitular .texte div", { y: "0%", duration: 1.5, delay: 0.8, ease: "power4.out" });
                    },
                },
                opacity: 1,
                y: "0%",
            ...
            _n.fromTo(".innerInverse", { y: -1 * Bo + "px" }, { scrollTrigger: { trigger: ".STitular", start: "top bottom", end: "+=" + Bo, scrub: !0 }, y: "0px", ease: "none" }),
            _n.fromTo(".img1", { x: 0, y: 0.4 * Bo + "px" }, { scrollTrigger: { trigger: ".STitular", start: "top top", end: "+=" + Bo, scrub: !0 }, x: -0.35 * window.innerWidth + "px", y: "-25%" }),
            _n.fromTo(".img1 .transi", { scale: 0.5 }, { scrollTrigger: { trigger: ".STitular", start: "top top", end: "+=" + Bo, scrub: !0 }, scale: 0.2 }),
            _n.fromTo(".img2", { x: 0, y: 0.4 * Bo + "px" }, { scrollTrigger: { trigger: ".STitular", start: "top -40%", end: "+=" + Bo, scrub: !0 }, x: -0.35 * window.innerWidth + "px", y: "-75%" }),
            _n.fromTo(".img2 .transi", { scale: 0.5 }, { scrollTrigger: { trigger: ".STitular", start: "top -40%", end: "+=" + Bo, scrub: !0 }, scale: 0.2 }),
            _n.fromTo(".img3", { x: 0, y: 0.4 * Bo + "px" }, { scrollTrigger: { trigger: ".STitular", start: "top -120%", end: "+=" + Bo, scrub: !0 }, x: 0.35 * window.innerWidth + "px", y: "-25%" }),
            _n.fromTo(".img3 .transi", { scale: 0.5 }, { scrollTrigger: { trigger: ".STitular", start: "top -120%", end: "+=" + Bo, scrub: !0 }, scale: 0.2 }),
            _n.fromTo(".img4", { x: 0, y: 0.4 * Bo + "px" }, { scrollTrigger: { trigger: ".STitular", start: "top -80%", end: "+=" + Bo, scrub: !0 }, x: 0.35 * window.innerWidth + "px", y: "-75%" }),
            _n.fromTo(".img4 .transi", { scale: 0.5 }, { scrollTrigger: { trigger: ".STitular", start: "top -80%", end: "+=" + Bo, scrub: !0 }, scale: 0.2 }),
            Oo.create({
                trigger: ".SProfessor",
                start: "top top",
                end: "+=" + 2 * Bo + "px",
            ...
            _n.to(".portrait", { scrollTrigger: { trigger: ".SProfessor", start: "top bottom", end: "+=" + 3 * Bo + "px", scrub: !0 }, scale: 0.265, ease: "none" }),
            _n.to(".portrait img", { scrollTrigger: { trigger: ".SProfessor", start: "top bottom", end: "+=" + 3 * Bo + "px", scrub: !0 }, scale: 1, ease: "none" }),
            _n.to(".animO", { scrollTrigger: { trigger: ".SProfessor", start: "top bottom", end: "+=" + 3 * Bo + "px", scrub: !0 }, y: "0%", ease: "none" }),
            document.querySelectorAll(".SStudent .lArt").forEach(function (t) {
                var e = t.getBoundingClientRect().left + Bo - 0.8 * window.innerWidth;
                _n.fromTo(t.querySelector("span"), { x: "-100%" }, { scrollTrigger: { trigger: ".scrollHori2", start: "top bottom-=" + e, end: "+=" + t.offsetWidth, scrub: !0 }, x: "0%", ease: "none" });
            }),
            _n.to(".scrollHori2", {
                scrollTrigger: { trigger: ".scrollHori2", end: "+=" + (document.querySelector(".scrollHori2").offsetWidth - window.innerWidth), pin: !0, scrub: !0 },
        ...
        _n.fromTo(".fullImg img", { x: "-95%" }, { x: "95%", scale: 1.05, ease: "none", scrollTrigger: { trigger: ".SAuthor", scrub: !0, start: "top top+=" + a + "px", end: "+=" + 2 * window.innerWidth } }),
            _n.to(".titreEleves", { scrollTrigger: { trigger: ".SAuthor", start: "top top+=" + (Bo + 2 * window.innerWidth), end: "+=" + 2 * window.innerWidth, scrub: !0 }, x: 2 * window.innerWidth + "px", ease: "none" }),
            _n.to(".grosTitre2Fin", { scrollTrigger: { trigger: ".SAuthor", start: "top top+=" + (Bo + 3 * window.innerWidth), end: "+=" + 3 * window.innerWidth, scrub: !0 }, x: "-20%", ease: "none" }),
            _n.to(".rond", {
                scrollTrigger: {
                    trigger: ".SAuthor",
                    ...
                    scrub: !0,
                    onUpdate: function (t) {
                        0 != _n.getProperty(".rond", "scale") && _n.set(".rond img", { scale: 1 / _n.getProperty(".rond", "scale") });
                    },
                },
            ...
            _n.to(".rond img", { scrollTrigger: { trigger: ".SAuthor", start: "top top+=" + (Bo + window.innerWidth), end: "+=" + (window.innerWidth + Bo) + "px", scrub: !0 }, rotation: -120, ease: "none" });
        var u = window.innerWidth;
        Oo.create({ trigger: ".apparition", start: "top top", end: "+=" + u + "px", pin: !0 }),
            _n.fromTo(".grosTitre22", { y: -1 * Bo + "px" }, { scrollTrigger: { trigger: ".haut", start: "top bottom", end: "top top", scrub: !0 }, y: "0px", ease: "none" }),
            _n.to(".SAuthor .gauche, .SAuthor .droite", { scrollTrigger: { trigger: ".SAuthor", start: "top 100%", end: "+=" + (window.innerWidth + Bo) + "px", scrub: !0 }, x: "0%", ease: "none" }),
            _n.to(".comp", { scrollTrigger: { trigger: ".haut", start: "top top+=" + window.innerWidth, end: "+=" + 2 * window.innerWidth + "px", scrub: !0 }, y: "0%", ease: "none" }),
            ...
            _n.to(".innerImgZ img", {
                scrollTrigger: {
                    ...
                    scrub: !0,
                    onUpdate: function (t) {
                        t.progress > 0.5 && _n.set(".zoom", { opacity: _n.utils.mapRange(0.5, 1, 1, 0.15, t.progress), blur: _n.utils.mapRange(0.5, 1, 0, 20, t.progress) });
                    },
                },
                scale: 0.9,
                ease: "none",
            ...
            Oo.create({
                ...
                onUpdate: function (t) {
                    _n.set(".zoom", { opacity: _n.utils.mapRange(0, 1, 0.15, 0, t.progress) });
                },
            });
        var l = document.querySelector(".SContact").offsetHeight + document.querySelector(".finAuthor").offsetHeight;
        Oo.create({ trigger: ".innerImgZ", start: "top top", end: "+=" + l + Bo + "px", pin: !0, pinSpacing: !1 }),
            qo() ||
                (document.querySelectorAll(".people span").forEach(function (t) {
                    var e = t.getBoundingClientRect().left - 1.25 * window.innerWidth;
                    _n.to(t, { scrollTrigger: { trigger: ".people", start: "top top-=" + e, end: "+=" + window.innerWidth, scrub: !0 }, y: "0%", scale: 1, ease: "elastic.inOut" });
                }),
                _n.to(".people", {
                    scrollTrigger: { trigger: ".people", end: "+=" + (document.querySelector(".people").offsetWidth - window.innerWidth), scrub: !0, pin: !0 },
        ...
        if (
                    ...
                    _n.to(".pastE.affiche", {
                        ...
                        onComplete: function () {
                            document.querySelectorAll(".pastE").forEach(function (t) {
                                ...
                                alert("cas: annee"),
                                Po.resize(),
                                _n.to('.pastE[data-annee="' + document.getElementById("annee").value + '"]', { opacity: 1, duration: 0.2, stagger: 0.1 });
                        },
                    });
            }),
            document.addEventListener("click", function (t) {
                if ((Wo || ((Wo = !0), new Lo({ withAudio: !0 })), t.target.closest(".play1")))
                    _n.to(".innerVideo .inner", { duration: 0.5, ease: "power2.inOut", x: "-100%" }),
                        _n.to(".innerVideo .innerBtn, .innerVideo .inner img", { duration: 0.5, ease: "power2.inOut", x: "100%" }),
                        document.getElementById("vid1").play();
                else if (t.target.closest(".play2"))
                    _n.to(".innerPlayer .inner", { duration: 0.5, ease: "power2.inOut", x: "-100%" }),
                        _n.to(".innerPlayer .innerBtn, .innerPlayer .inner img", { duration: 0.5, ease: "power2.inOut", x: "100%" }),
                    ...
                    Do ||
                        ...
                        _n.to(u.querySelector("img"), { duration: 0.5, x: "98%", ease: "power2.inOut" }),
                        _n.fromTo(c, { x: "100%" }, { duration: 0.5, x: "0%", ease: "power2.inOut" }),
                        _n.fromTo(
                            c.querySelector("img"),
                            { x: "-98%" },
                            {
                        ...
                        _n.to(l.querySelectorAll("span"), { stagger: 0.05, x: -0.03 * window.innerWidth + "px", opacity: 0, duration: 0.3, ease: "power2.in" }),
                        _n.fromTo(
                        ...
                        _n.fromTo(f, { opacity: 0 }, { opacity: 1, duration: 0.3, delay: 0.7 }));
                    ...
                    Do ||
                        ...
                        (function () {
                            var t = document.querySelector(".carouI.current"),
                                ...
                                r =
                                    null !== document.querySelector(".carouI.current").previousElementSibling
                                        ? document.querySelector(".carouI.current").previousElementSibling
                                        : document.querySelectorAll(".carouI")[document.querySelectorAll(".carouI").length - 1],
                                n =
                                    null !== document.querySelector(".nomOrgue.current").previousElementSibling
                                        ? document.querySelector(".nomOrgue.current").previousElementSibling
                                        : document.querySelectorAll(".nomOrgue")[document.querySelectorAll(".nomOrgue").length - 1],
                                i = document.querySelector(".artist .current"),
                                o =
                                    null !== document.querySelector(".artist .current").previousElementSibling
                                        ? document.querySelector(".artist .current").previousElementSibling
                                        : document.querySelectorAll(".artist div")[document.querySelectorAll(".artist div").length - 1];
                            _n.to(t, { duration: 0.5, x: "100%", ease: "power2.inOut" }),
                                _n.to(t.querySelector("img"), { duration: 0.5, x: "-98%", ease: "power2.inOut" }),
                                _n.fromTo(r, { x: "-100%" }, { duration: 0.5, x: "0%", ease: "power2.inOut" }),
                                _n.fromTo(
                                    r.querySelector("img"),
                                    { x: "98%" },
                                    {
                                ...
                                _n.to(e.querySelectorAll("span"), { stagger: 0.05, x: 0.03 * window.innerWidth + "px", opacity: 0, duration: 0.3, ease: "power2.in" }),
                                _n.fromTo(
                                ...
                                _n.fromTo(o, { opacity: 0 }, { opacity: 1, duration: 0.3, delay: 0.7 });
                        })());
                    ...
                    (Do = !0),
                        ...
                        _n.delayedCall(1, function () {
                            (document.getElementById("menu").style.display = "flex"), _n.fromTo("hr", { opacity: 0 }, { opacity: 1, ease: "power2.inOut", stagger: 0.06, duration: 1 });
                        }),
                        _n.delayedCall(0.7, function () {
                            _n.fromTo(".entree .nom", { y: "-80%" }, { y: "0%", ease: "power4.out", stagger: 0.06, duration: 1.8 }),
                                _n.fromTo(".entree .part", { y: "-100%", x: "-100%", opacity: 0 }, { y: "0%", opacity: 1, ease: "power4.out", stagger: 0.06, duration: 2.5 });
                        }),
                    ...
                    (Do = !0),
                        ...
                        _n.to(".entree .nom", { y: "-80%", ease: "power4.in", stagger: -0.06, duration: 1 });
                    ...
                    t.target.closest(".toSon1")
                        ? t.target.closest(".toSon1").classList.contains("actif")
                            ? (t.target.closest(".toSon1").classList.remove("actif"), No.mute())
                            : (t.target.closest(".toSon1").classList.add("actif"), No.play(No, Yo, Vo, Uo))
                        : t.target.closest(".toSon2")
                        ? t.target.closest(".toSon2").classList.contains("actif")
                            ? (t.target.closest(".toSon2").classList.remove("actif"), Yo.mute())
                            : (t.target.closest(".toSon2").classList.add("actif"), Yo.play(No, Yo, Vo, Uo))
                        : t.target.closest(".toSon3")
                        ? t.target.closest(".toSon3").classList.contains("actif")
                            ? (t.target.closest(".toSon3").classList.remove("actif"), Vo.mute())
                            : (t.target.closest(".toSon3").classList.add("actif"), Vo.play(No, Yo, Vo, Uo))
                        : t.target.closest(".toSon4") &&
                          (t.target.closest(".toSon4").classList.contains("actif") ? (t.target.closest(".toSon4").classList.remove("actif"), Uo.mute()) : (t.target.closest(".toSon4").classList.add("actif"), Uo.play(No, Yo, Vo, Uo)));
                var u, l, c, d, p, f;
            }),
            qo() ||
                (Oo.scrollerProxy(Ro, {
            ...
            setTimeout(function () {
                document.body.classList.remove("load"),
                    _n.to(".scroll", { opacity: 1, ease: "power2.out", duration: 1, delay: 3 }),
                    jo(".SDeb", 0, !0),
                    qo()
                        ? (window.scrollTo(0, 0),
                          (function () {
                        ...
                        : (_n.fromTo(".nota", { y: "-150%", opacity: 0 }, { y: "0%", opacity: 1, stagger: 0.1, duration: 1.1, delay: 0.5, ease: "elastic.out" }),
                          _n.to(".notesB", { y: "-30%", duration: 1.6, delay: 1, ease: "power4.inOut" }),
                          Xo(),
                          Po.wheel(),
                          Po.resize());
            }, 1e3),
